...
const DashboardContent = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const donationsByUserResponse = await axios.get('https://nourishnet-1hvx.onrender.com/donate/count/byUser');
        const unprocessedDonationsResponse = await axios.get('https://nourishnet-1hvx.onrender.com/donate/count/unprocessedbyUser');
        const donationsToAssignResponse = await axios.get('https://nourishnet-1hvx.onrender.com/donate/count/toAssignbyUser');
        const uncollectedDonationsResponse = await axios.get('https://nourishnet-1hvx.onrender.com/donate/count/uncollectedbyUser');
